...
/// HomeScreen => Search Results => Displayed Data => click over one data => click over one face match
class PossibleFaceMatchDetailsWidget extends StatefulWidget {
  final Object heroKey;
  final String userToken;
  final PersonFoundMessageModel foundPersonDetails;

  const PossibleFaceMatchDetailsWidget(
      {Key key,
  ...
  @override
  _PossibleFaceMatchDetailsWidgetState createState() =>
      _PossibleFaceMatchDetailsWidgetState();
}

class _PossibleFaceMatchDetailsWidgetState
    extends State<PossibleFaceMatchDetailsWidget>
  ...
  void _saveImageToDownloadsFolderAsync(final BuildContext context) async {
    ...
    try {
      ...
      var foundImageBase64 = _displayedImageB64?.split(',')?.last;
