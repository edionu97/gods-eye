...
import 'component/possible_face_match_component.dart';


/// This is the component that is displayed when the user clicks one of the items from
/// HomeScreen => Search Results => displayed data
class PossibleSearchResultDetailsScreenWidget extends StatefulWidget {
  ...
  const PossibleSearchResultDetailsScreenWidget(
      {Key key,
...
class _StatePersonSearchRequestDetailsState
    extends State<PossibleSearchResultDetailsScreenWidget> {
